	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button class="close" type="button" data-dismiss="modal" aria-hidden="ture">&times;</button>
...
/*
replyService.add(
		{reply:"JS ajax Test12345", replyer:"tester1", bno:bnoValue},
		function(result){
...
replyService.update(
		{reply:"JS update test1010", rno:rnoValue},
		function(message) {
			if(message==="success"){
				alert("UPDATE")
			}
