				...
				<div class='row'>
					<div class="col-lg-12">
						<form id='searchForm' action="/board/list" method='get'>
							<select name='type'>
								<option value="" <c:out value="${pageMaker.criteria.type == null?'selected':''}"/>>-선택-</option>
...
<script type="text/javascript">
    $(document).ready(function() {
    	...
    	function checkModal(result) {
    		...
    		if (parseInt(result) > 0) { //parseInt:int로 변환 가능한지 체크
        ...
        $("#searchForm button").on("click",
        	function(e) {
        		...
        		searchForm.find("input[name='pageNum']").val("1"); //검색하면 1페이지로 가도록 동작
        		e.preventDefault();
        		searchForm.submit();
        });
